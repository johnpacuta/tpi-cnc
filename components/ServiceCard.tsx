...
export default function ServiceCard({
    ...
    return (
        ...
        >
            <div
                className="bg-white rounded-2xl shadow-lg md:hover:shadow-xl transition-all duration-300 md:transform md:group-hover:-translate-y-1 border border-gray-100 h-[550px]">
