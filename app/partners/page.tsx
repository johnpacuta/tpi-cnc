        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="text-center">
            <p className="text-lg text-gray-600">
              TPI CNC Inc. partners with industry-leading manufacturers to deliver exceptional quality and innovation in manufacturing solutions.
            </p>
          </div>
          ...
          <div className="relative">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
                Our strategic partnerships enable us to deliver exceptional value and innovative solutions to our clients
              </p>
            </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
              <h3 className="text-2xl font-semibold text-brand-blue mb-6">Partner With Us</h3>
              <p className="text-gray-600 mb-8">
                Interested in becoming a partner? Fill out the form below and our team will get in touch with you to discuss partnership opportunities.
              </p>
              ...
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="message"
                    name="message"
                    placeholder="Tell us about your company and how you envision partnering with TPI CNC Inc."
                    className="h-32"
                    required
                  />
                </div>
